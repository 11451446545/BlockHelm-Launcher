...
public sealed class RemoteManifestLauncherUpdateService : ILauncherUpdateService
{
    ...
    private const int MaximumDownloadUrls = 4;
    ...
    public RemoteManifestLauncherUpdateService(
        ...
        LauncherUpdateServerConfiguration? serverConfiguration = null)
        : this(
            httpClient,
            logger,
            serverConfiguration is null
                ...
                [
                    ...
                    new("preview", serverConfiguration.PreviewManifestUrlTemplate, 2)
                ])
    {
    }
    ...
    private static void ValidateManifest(RemoteUpdateManifestDto manifest, string expectedChannel)
    {
        ...
        if (!string.Equals(asset.Platform?.Trim(), "windows", StringComparison.OrdinalIgnoreCase)
            ...
            || asset.Urls is not { Count: > 0 and <= MaximumDownloadUrls })
        {
    ...
    public static bool TryCalculateVersionCode(string? value, out int versionCode)
    {
        ...
        if (text.Length == 8
            ...
            && hexadecimalVersionCode > 0)
        {
            versionCode = hexadecimalVersionCode;
            return true;
        }
        var betaRevision = 99;
    ...
    internal sealed class RemoteUpdateManifestDto
    {
        ...
        [JsonPropertyName("versionName")] public string? VersionName { get; init; }
